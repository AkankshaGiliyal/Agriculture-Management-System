...
<form method="POST" class="form-inline" action="additem.php">
  ...
  <div class="form-group">
    <label for="name">Month Grown</label>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
       <label for="name">Pesticide Used</label>
               ...
               if ($result -> num_rows >  0) {
                 ...
                 while ($row = $result->fetch_assoc())
				 {
                   ...
                   <tr>
                      ...
                      <th><?php echo $row["crop_name"] ?></th>
                      <th><?php echo $row["month"] ?></th>
                      <th><?php echo $row["quantity"]  ?></th>
                      <th><?php echo $row["field_id"]  ?></th>
                      <th><?php echo $row["pesticide_name"]  ?></th>
                      <th><?php echo $row["warehouse_id"]  ?></th>

                    <th>
                   <!-- <a href="up"Edit</a><a href="cropedit.php?id=<?php echo $row["crop_id"] ?>">Edit</a> <a href="up"Edit</a> -->

                    <a href="delete.php?id=<?php echo $row["crop_id"] ?>">Delete</a></th>
