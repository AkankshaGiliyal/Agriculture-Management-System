...
<body>
    ...
    <div class="page-container">
     ...
     <h1 style="text-align:center">Add Item Here</h1>
            <body>
<form method="POST" class="form-inline" action="pesticideadditem.php">
 
  <div class="form-group">
    <label for="name">Pesticide Name</label>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Pesticide</h4>
               ...
               if ($result -> num_rows >  0) {
                 ...
                 while ($row = $result->fetch_assoc())
				 {
                  ...
                  <!--  <th><?php echo $count ?></th>   -->
                      <th><?php echo $row["pesticide_name"] ?></th>
                      <th><?php echo $row["description"] ?></th>
                      <th><?php echo $row["cost"]  ?></th>
                     

                    <th>
  <!-- <a href="up"Edit</a><a href="edit.php?id=<?php echo $row["pesticide_name"] ?>">Edit</a> <a href="up"Edit</a>   -->

    <a href="pesticidedelete.php?id=<?php echo $row["pesticide_name"] ?>">Delete</a></th>
